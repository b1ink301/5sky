...
@interface SkyImageViewerView : UIScrollView

- (void)setImage:(UIImage *)image;

@end

@interface SkyImageViewerController ()

@property(strong, nonatomic) SkyImageViewerView* viewerView;

@end

@implementation SkyImageViewerController

- (instancetype)init
{
    self = [super init];
    if (self) {
        _viewerView = [[SkyImageViewerView alloc]initWithFrame:[UIScreen mainScreen].bounds];
...
@interface SkyImageViewerView () <UIScrollViewDelegate>
...
@implementation SkyImageViewerView

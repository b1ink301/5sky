...
#define CACHE_PATH @"/Library/Application Support/5sky/caches"

#pragma mark - Utils

#define rad(degrees) ((degrees) / (180.0 / M_PI))
#define kLineWidth 1.4f
...
- (instancetype)init
{
    ...
    if(self)
    {
        ...
        {
        	NSError *error;
            [self.fileManager createDirectoryAtPath:self.cachePath withIntermediateDirectories:YES attributes:nil error:&error];
        }
    }
    return self;
}
